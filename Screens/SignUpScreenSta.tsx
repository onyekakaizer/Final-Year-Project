...
const SignUpScreenSta = (props: ChatScreenProp) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.InnerContainer}>
            <Text style={styles.signUpTxt}>Staff Sign Up</Text>
            <View style = {{backgroundColor: '#d4d5d4', borderRadius: 40, elevation: 4, marginBottom: 15}}>
                <TextInput
...
export default SignUpScreenSta;
